...
$$\hat\Sigma_{\text{n}} = \frac{1}{n}\sum\limits_{i=1}^{n}_i_i^T$$
...
\lambda_{11} & {\color{blue}{0}} & } & \ldots & {\color{blue}{0}} \\
\lambda_{21} & } & {\color{blue}{0}} & \ldots & {\color{blue}{0}} \\ 
...
Run the Gibbs sampler to obtain posterior estimate of $\Sigma^{(m)} \in {\mathbb{R}}^$ via 
