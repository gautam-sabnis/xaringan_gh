...
-	A large number of covariates about the donors
...
- Application to gene expression data reveals certain biological processes but more research is needed to understand what is jointly regulating the expressed genes. 
