---
title: "A Divide and Conquer Approach to High Dimensional Bayesian Factor Models"
subtitle: ""
...
On ${\color{blue}{\text{machine m}}}$,
$$y_i^{(m)} = \Lambda^{(m)}_{{\color{blue}{p_g\times k_g}}}\;{\eta^{(m)}_{i_{\color{blue}{k_g\times 1}}}} + \epsilon_i^{(m)}, \quad i = 1, \ldots, n,$$ 
...
Run the Gibbs sampler to obtain posterior estimate of $\Sigma^{(m)} \in {\mathbb{R}}^{\color{blue}{p_g \times p_g}}$ via 
...
knitr::include_graphics("inducingcorr2.jpeg")
```
...
knitr::include_graphics("inducingcorr3.jpeg")
```
...
knitr::include_graphics("errR.jpg")
```
]
.pull-right[
```{r out.width="80%", echo=FALSE, fig.cap = ""}
knitr::include_graphics("timeR.jpg")
```
...
.pull-left[
```{r out.width="80%", echo=FALSE,fig.cap = "Frobenius norm errors for p=1008"}
knitr::include_graphics("froerr-RS-p252.jpeg")
```
]
.pull-right[
```{r out.width="80%", echo=FALSE, fig.cap = "Operator norm errors for p=1008"}
knitr::include_graphics("operr-RS-p1008.jpeg")
```
...
### Sensitivity to Random splitting
.pull-left[
```{r out.width="80%", echo=FALSE,fig.cap = "Frobenius norm errors for p=2016"}
knitr::include_graphics("froerr-RS-p1008.jpeg")
```
]
.pull-right[
```{r out.width="80%", echo=FALSE, fig.cap = "Operator norm errors for p=2016"}
knitr::include_graphics("operr-RS-p2016.jpeg")
```
...
.pull-left[
```{r out.width="80%", echo=FALSE,fig.cap = ""}
knitr::include_graphics("opcomp2.jpg")
```
]
.pull-right[
```{r out.width="80%", echo=FALSE, fig.cap = ""}
knitr::include_graphics("timecomp2.jpg")
```
]
???
...
.pull-left[
```{r out.width="100%", echo=FALSE,fig.cap = ""}
knitr::include_graphics("err4032.jpg")
```
]
.pull-right[
```{r out.width="100%", echo=FALSE, fig.cap = ""}
knitr::include_graphics("time4032.jpg")
```
]
--
...
```{r out.width="100%", echo=FALSE}
knitr::include_graphics("thyroid.jpg")
```
